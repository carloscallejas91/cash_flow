...
// Light Theme - Core Scheme
const Color primary = Color(0xff004D40);
const Color onPrimary = Color(0xffFFFFFF);
const Color primaryContainer = Color(0xffE8F5E9);
const Color onPrimaryContainer = Color(0xff004D40);

const Color secondary = Color(0xff9E9D24);
const Color onSecondary = Color(0xff212121);
const Color secondaryContainer = Color(0xffF0F4C3);
const Color onSecondaryContainer = Color(0xff9E9D24);

const Color tertiary = Color(0xff81C784);
const Color onTertiary = Color(0xff212121);
const Color tertiaryContainer = Color(0xff1B5E20);
const Color onTertiaryContainer = Color(0xff81C784);

const Color background = Color(0xffFAFAFA);
const Color onBackground = Color(0xff212121);
const Color surface = Color(0xffFFFFFF);
const Color onSurface = Color(0xff212121);
...
const Color onErrorContainer = Color(0xffF44336);

/* Custom Color */
const Color backgroundVariant = Color(0xffE7EDDE);
...
const Color onYellowContainer = Color(0xff212121);
